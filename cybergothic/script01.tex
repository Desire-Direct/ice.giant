...
\usepackage{pifont}	% Postscript ZapfDingbats (no speaker symbol avail)
% bibliography
...
might want to skip the scan of a lenghtly brainwash but do carry on as the morality play swiftly 
...
and display most morbid behaviour,
...
The exploit shatters the defective interface 
...
Worringer insists on the inner "will to FORM" (form is noun!)
as precondition of apperceptive activity, 
expressed in materialisation WITHIN the object.(wor, 8)

\paragraph{Conclusion} 
Although no lesser geocentric than Plato, 
...
Plato is aware that the fire in the cave corresponds to the powers of the sun,(rep, 244) 
fueled from fossilized bones of (un)deceased cave dwellers; 
the alternative ending suggests ignition of the overheated machinic black sun and
rebellion against guardian watchdogs in will to see the sun in-itself, 
and so the philosopher returns to the almost deserted home.
Heraclitus and a cohesive underground movement of proletarian fire-worshippers 
are in favour to lose everything but their chains,
holding the wisdom that the ring of fire must be handled with extreme caution.
Peras colonialises and terrorizes earth through
atomic fission and extendible electromagnetic radiation, 
and extracts finitely from the harmonic flux of the indeterminate Dyad to
turn dynamics into miniscule units of static being
and drags the viscous mass far off the core 
for lone- and quarrelsome existence.
